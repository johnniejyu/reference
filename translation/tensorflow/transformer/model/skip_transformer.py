# TODO Copyright 2018 MLBenchmark Group. All Rights Reserved.
#
...
# ==============================================================================
"""Defines the Skip Transformer model, and its encoder and decoder stacks.

Model paper: TODO https://arxiv.org/pdf/1706.03762.pdf
...
class SkipTransformer(object):
  """Skip Transformer model for sequence to sequence data.

  Implemented as described in: https://arxiv.org/pdf/1706.03762.pdf

  The Skip Transformer model consists of an encoder and decoder. The input is an int
